...
SceneNode*				g_nodeBody;
SceneNode*				g_nodeWheel1;
SceneNode*				g_nodeWheel2;
SceneNode*				g_nodeWheel3;
SceneNode*				g_nodeWheel4;
SceneNode*				g_nodeWheels;
SceneNode*				g_cam_node;
SceneNode*				g_bulllet_node;
...
HRESULT InitialiseGraphics()
{
	...
	g_nodeBody = new SceneNode();
	g_nodeWheel1 = new SceneNode();
	g_nodeWheel2 = new SceneNode();
	g_nodeWheel3 = new SceneNode();
	g_nodeWheel4 = new SceneNode();
	g_bulllet_node = new SceneNode();
	
	g_cam_node->SetModel(M_Camera);
	g_nodeBody->SetModel(model1);
	g_nodeWheel1->SetModel(model2);
	g_nodeWheel2->SetModel(model2);
	g_nodeWheel3->SetModel(model2);
	g_nodeWheel4->SetModel(model2);
	g_bulllet_node->SetModel(M_bullet);

	g_root_node->addChildNode(g_cam_node);
	g_root_node->addChildNode(g_bulllet_node);

	g_root_node->addChildNode(g_nodeBody);

	g_nodeBody->addChildNode(g_nodeWheel1);
	g_nodeBody->addChildNode(g_nodeWheel2);
	g_nodeBody->addChildNode(g_nodeWheel3);
	g_nodeBody->addChildNode(g_nodeWheel4);

	g_cam_node->setNodeScale(0.3);
	g_root_node->setNodeScale(1.0);
	g_bulllet_node->setNodeScale(0.1);

	g_root_node->setNodePosition(0.0, 0.0, 0.0);
	g_nodeWheel1->setNodePosition(-0.9, -1.0, 0.8);
	g_nodeWheel2->setNodePosition(0.9, -1.0, -0.8);
	g_nodeWheel3->setNodePosition(-0.9, -1.0, -0.8);
	g_nodeWheel4->setNodePosition(0.9, -1.0, 0.8);
	g_nodeWheel1->setNodeScale(0.2);
	g_nodeWheel2->setNodeScale(0.2);
	g_nodeWheel3->setNodeScale(0.2);
	g_nodeWheel4->setNodeScale(0.2);
...
//	g_bulllet_node->setNodePosition(camera1->getX(), camera1->getY(), camera1->getZ());
	g_bulllet_node->setNodePosition(50, 50, 50);
